...
/*
    ...
    */
    ...
    await db.execute(`INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status) SELECT dog_id, '2025-06-09 08:00:00', 30, 'Parklands', 'closed' FROM Dogs WHERE name = 'Max';`);
