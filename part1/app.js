...
/*
    ...
    */
    ...
    // insert application
    await db.execute(`INSERT INTO WalkRequests (request_id, walker_id, applied_at) SELECT dog_id, '2025-06-09 08:00:00', 30, 'Parklands', 'completed' FROM Dogs WHERE name = 'Max';`);
